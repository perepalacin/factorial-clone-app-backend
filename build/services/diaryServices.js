...
exports.addDiaryEntry = exports.getEntriesWithoutSensitiveInfo = exports.findById = exports.getEntries = void 0;
...
const addDiaryEntry = (newDiaryBody) => {
    const newDiaryEntry = Object.assign({ id: diaries.length }, newDiaryBody);
